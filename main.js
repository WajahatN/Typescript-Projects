...
return album;
var album1 = makeAlbum('Vitel Signs', 'Mum Tum');
...
var greatMagicianNames = make_great(magicianName);
console.log("Orignal Magicians:");
showMagicians(magicianName);
showMagicians(greatMagicianNames);
//Question No 43;
Sandwiches: function makeSandwich() {
    var items = [];
...
//Question No 44:
Cars: function createCar(manufacturer, model) {
    var properties = [];
...
var myCar = createCar("Toyota", "Corolla", ["color", "red"], ["optionalFeature", "sunroof"], ["speed", "280 KM/hour"]);
console.log(myCar);
// Q Intentional Error
